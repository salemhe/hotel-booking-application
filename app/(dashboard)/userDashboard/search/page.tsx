    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-950">
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        <header className="mb-8">
          ...
          <div className="flex md:items-center gap-3 mb-6 flex-col md:flex-row w-full ">
            ...
            {loading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {Array.from({ length: 4 }).map((_, index) => (
                  <Card
                    key={index}
                    className="animate-pulse overflow-hidden border-zinc-200/80 dark:border-zinc-800"
                  >
              ...
              <div className="flex flex-col items-center justify-center text-center py-10">
                ...
                <p className="text-muted-foreground">
                  No reservations found. Try adjusting your filters or search
                  query.
                </p>
              </div>
            ) : (
