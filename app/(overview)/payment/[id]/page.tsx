...
export default function PaymentPage() {
  ...
  const adjustDiningTime = (fnc: string) => {
    if (fnc === "subtract") {
      const newTime = Math.max(30, Math.min(300, diningTime - 10));
          ...
          <div className="space-y-4">
            ...
            <div className="mb-4">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleCardDetailsChange("bank", value)
                }
              >
                <SelectTrigger>
    ...
    <div className="max-w-md mx-auto p-4">
      ...
      <div className="mb-4">
        ...
        <div className="date-picker mb-4">
          ...
          <div className="border rounded-md p-2 text-gray-500">14 Feb</div>
        </div>
  ...
  const renderPaymentStep = () => (
    <div className="space-y-4">
      ...
      <div className="mt-4">{renderPaymentMethodDetails()}</div>
