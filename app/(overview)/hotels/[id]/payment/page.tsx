...
import BookingGuard from "@/app/components/BookingGuard";
      ...
      <div className="px-4 sm:px-6 lg:px-24 py-6 sm:py-8 lg:py-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6 sm:mb-8">
          <div className="w-full sm:w-24 h-40 sm:h-20 rounded-lg overflow-hidden flex-shrink-0">
            <img
              src={
                bookingData.hotelInfo?.profileImages?.[0] ||
                "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=200&h=160&fit=crop"
              }
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs sm:text-sm font-medium">
                {bookingData.hotelInfo?.rating || 4.8} (
                {bookingData.hotelInfo?.reviews?.toLocaleString() || 1000}{" "}
                reviews)
              </span>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
                ...
                <div className="font-medium text-gray-900 flex items-center justify-between text-sm sm:text-base">
                  <span className="truncate">
                    {bookingData.guests}{" "}
                    {parseInt(bookingData.guests) === 1 ? "person" : "people"}
                  </span>
                  <Edit2 className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0 ml-2" />
                </div>
              </div>
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              ...
              >
                ...
                <div className="text-xs sm:text-sm text-gray-600">
                  ...
                  {format(checkInDate, "do MMM, yyyy")}. No extra fees
                </div>
              </div>
            </div>
