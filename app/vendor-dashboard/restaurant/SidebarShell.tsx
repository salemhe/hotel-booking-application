...
export default function RestaurantLayout({
  ...
  const menuItems = [
    { label: "Dashboard", href: "/vendor-dashboard/restaurant/dashboard", icon: HomeIcon },
    { label: "Reservations", href: "/vendor-dashboard/restaurant/reservations", icon: CalendarIcon },
    //{ label: "User's Management", href: "/vendor-dashboard/restaurant/users", icon: UserGroupIcon },
    { label: "Payments", href: "/vendor-dashboard/restaurant/payments", icon: CurrencyDollarIcon },
    { label: "Staff", href: "/vendor-dashboard/restaurant/staff", icon: UserGroupIcon },
  ];
  const bottomItems = [
    { label: "Settings", href: "/vendor-dashboard/restaurant/settings", icon: Cog6ToothIcon },
    { label: "Logout", href: "/vendor-login", icon: ArrowRightOnRectangleIcon },
  ];
