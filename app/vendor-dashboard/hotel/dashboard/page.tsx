...
//               <Avatar className="w-9 h-9 rounded-full bg-gray-300"><AvatarImage src={userProfile.avatar || "/placeholder.svg?height=32&width=32"} />
...
//         <div className='flex w-full px-[32px] pt-[24px] pb-[34px] flex-col items-start gap-6'>
//           {/* ======================= C. ALERT ======================= 
...
//                 className="p-1 rounded hover:bg-[#FEF3C7]"
//               >
//                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
//       <div className="px-3 sm:px-5 lg:px-5 py-4">
//         {/* Welcome Section */}
//         <div className="w-full self-stretch flex items-center justify-between mb-5 px-6">
//           <div>
...
//               ) : 'there'}!
//             </h1>
//             <p className="text-sm text-gray-500">{"Here's what is happening today."}</p>
//           </div>
...
//         ======================================================== */}
//         <div className="flex w-[965px] bg-white rounded-xl border-t border-b border-1 border-[#E5E7EB] justify-center items-center mb-6">
//          <Card>
...
//                 <p className="text-xl font-semibold text-gray-900 mt-1">{isLoading ? '-' : stats.reservationsToday}</p>
//                 <div className="flex items-center text-xs mt-1">
//                   {stats.reservationsTrend >= 0 ? (
//                       <>
//                         <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
//                         <span className="text-gray-400">{stats.reservationsTrend}% vs last week</span>
//                       </>
//                     ) : (
//                       <>
//                         <TrendingDown className="h-4 w-4 text-red-500 mr-1" />
//                         <span className="text-sm text-gray-400">{Math.abs(stats.reservationsTrend)}% vs last week</span>
//                       </>
//                     )}
//                 </div>
//               </div>
...
//                       <>
//                         <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
//                         <span className="text-gray-400">{stats.prepaidTrend}% vs last week</span>
//                       </>
//                     ) : (
//                       <>
//                         <TrendingDown className="h-4 w-4 text-red-500 mr-1" />
//                         <span className="text-sm text-gray-400">{Math.abs(stats.prepaidTrend)}% vs last week</span>
//                       </>
//                     )}
//               </div>
//             </div>
...
//                       <>
//                         <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
//                         <span className="mr-1 text-gray-500">{stats.guestsTrend}% vs last week</span>
//                       </>
//                     ) : (
//                       <>
//                         <TrendingDown className="h-4 w-4 text-red-500 mr-1" />
...
//                       <>
//                         <TrendingUp className="h-4 w-4 text-green-500 mr-1" />
//                         <span className="mr-1 text-red-500">{stats.pendingPaymentsTrend}% vs last week</span>
//                       </>
//                     ) : (
//                       <>
//                         <TrendingDown className="h-4 w-4 text-red-500 mr-1" />
//                         <span className="text-sm text-gray-400">{Math.abs(stats.pendingPaymentsTrend)}% vs last week</span>
//                       </>
//                     )}
//           </div>
//         </div>
...
//       <div className="flex w-full px-3 py-1 flex-col items-start gap-3 overflow-y-auto">
//         {isLoading ? (
...
//             const isIn30Mins = reservation.status === "In 30 mins"
//             const isConfirmed = reservation.status === "Confirmed"
//             const isPending = reservation.status === "Pending"

//             let badgeClasses = ""
//             let strokeColor = "#0A6C6D"

//             if (isUpcoming) {
//               badgeClasses = "border-[#B3D1D2] bg-[#E7F0F0] text-[#0A6C6D]"
//               strokeColor = "#0A6C6D"
//             } else if (isIn30Mins) {
//               badgeClasses = "border-[#FAE48A] bg-[#FCF6DE] text-[#A28200]"
//               strokeColor = "#A28200"
//             } else if (isConfirmed) {
//               badgeClasses = "border-[#22c55e] bg-[#dcfce7] text-[#15803d]"
//               strokeColor = "#15803d"
//             } else if (isPending) {
//               badgeClasses = "border-[#facc15] bg-[#fef9c3] text-[#854d0e]"
//               strokeColor = "#854d0e"
//             }
...
//                       className="mr-1"
//                     >
//                       <circle cx="10" cy="10" r="8" stroke={strokeColor} />
//                       <path d="M10 6v4l3 2" stroke={strokeColor} />
//                     </svg>
//                     {reservation.status}
//                   </span>
//                 </div>
