                ...
                {step === 1 && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup
                        value={String(newMenu.type)}
                        onValueChange={(val) =>
                          setNewMenu({ ...newMenu, type: val })
                        }
                        className="flex flex-wrap gap-4"
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="a-la-carte" id="a-la-carte" />
                          <Label htmlFor="a-la-carte" className="text-sm">
                            A la Carte
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="buffet" id="buffet" />
                          <Label htmlFor="buffet" className="text-sm">
                            Buffet
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="set-menu" id="set-menu" />
                          <Label htmlFor="set-menu" className="text-sm">
                            Set Menu
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            ...
                            id="tasting-menu"
                          />
                          <Label htmlFor="tasting-menu" className="text-sm">
                            Tasting Menu
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {[
                          ...
                          <Button
                            key={mealType}
                            variant={
                              (newMenu.mealTypes as string[]).includes(mealType)
                                ? "default"
                                : "secondary"
                            }
                            size="sm"
                            onClick={() => {
                              setNewMenu({
                                ...newMenu,
                                mealTypes: (
                                  newMenu.mealTypes as string[]
                                ).includes(mealType)
                                  ? (newMenu.mealTypes as string[]).filter(
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <Switch
                          ...
                          onChange={(e) =>
                            setNewMenu({
                              ...newMenu,
                              showOnApp: (e.target as HTMLInputElement).checked,
                            })
                          }
                        />
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup
                        value={String(newMenu.priceType)}
                        onValueChange={(val) => {
                      ...
                      >
                        <div className="space-y-2">
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem name="PriceType" value="fixed" id="fixed-price" />
                        ...
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem name="PriceType" value="per-item" id="per-item" />
