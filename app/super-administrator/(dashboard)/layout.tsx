...
const sidebarItems = [
  ...
  return (
    <ThemeProvider>
      ...
      {sidebarCollapsed && (
        <button
          className="fixed z-40 top-5 left-6 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md focus:outline-none"
        ...
        >
          ...
          <MenuIcon className="w-4 h-4 absolute" />
        </button>
      )}
      {/* Main Content */}
