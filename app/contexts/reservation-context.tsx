...
const defaultReservationData: ReservationData = {
  ...
  guests: 4,
  items: [
    { name: "Meze Platter", price: 15000, quantity: 2, category: "starters" },
    { name: "Chicken Springrolls", price: 12000, quantity: 1, category: "starters" },
  ],
...
export function ReservationProvider({ children }: { children: ReactNode }) {
  const [reservationData, setReservationData] = useState<ReservationData>(defaultReservationData)
