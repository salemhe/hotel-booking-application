              ...
              >
                <CardHeader className="p-0">
                  <div className="relative h-48">
                    <Image
                      src={`${restaurant.profileImage ? "https://hotel-booking-app-backend-30q1.onrender.com/uploads/${restaurant.profileImage}" : "/hero-bg.jpg"}`}
