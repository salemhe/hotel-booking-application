      ...
      <div>
        ...
        <div className="space-y-2">
          <div className="flex items-center">
            <input type="radio" name="rating" id="any-rating" className="mr-2" defaultChecked />
            <label htmlFor="any-rating" className="text-sm">Any ratings</label>
          </div>
          <div className="flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <span className="text-teal-600 font-medium border-b-2 border-teal-600 pb-1">Bookings/Reservations</span>
