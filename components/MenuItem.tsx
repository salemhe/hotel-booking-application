    ...
    <div className="w-full max-w-sm bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden transform transition-all hover:shadow-2xl p-6 border border-gray-200">
      ...
      <div className="py-4 space-y-2">
        ...
        <p className="text-sm text-gray-600">
          <span className="font-medium text-gray-800">Cuisine:</span> {cuisine} | {" "}
      ...
      <div className="flex justify-between items-center mt-5">
        ...
        <Button variant="outline" className="px-4 py-2 text-indigo-600 border-indigo-600 hover:bg-indigo-600 hover:text-white transition-all">
            <Pencil size={18} /> Edit
        </Button>
          </Link>
        <Button variant="destructive" size="icon" className="hover:scale-110 transition-all">
          <Trash2 />
        </Button>
      </div>
    </div>
