...
export default function ReservationSummary({ id }: { id: string }) {
  const {
    comboItems,
    // setComboItems,
    bottleItems,
  ...
  return (
    <div className="min-h-screen mb-[65px] mt-[20px] md:mt-0 bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-5 md:py-15 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-7 space-y-6">
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex rounded-2xl bg-white border p-4">
